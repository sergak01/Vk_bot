...
class Interface:
    ...
    def call(self, event):
        ...
        " сейчас в разработке и я могу немного.\nЕсли хочешь что-бы я " + \
        "нашел для тебя фильм, напиши мне такое сообщение:\nНайди (название" + \
        " фильма)\nПисать нужно без скобок.\nТакже я могу найти фильм по " + \
        "хештегу жанра. Например: #боевик\nЕсли что-то не будет получаться" + \
        " - напишите мне: помоги или help"
        self.vk.method(
            'messages.send', 
            {'user_id':int(event.user_id),'message':msg}
            )